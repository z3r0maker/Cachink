...
- Uso personal o para operar tu propio negocio.
- Puedes tener la app instalada en tantos dispositivos como necesites.
- Puedes invitar a tu equipo a usarla.

## 3. Uso no permitido

- Revender, redistribuir o modificar el binario oficial.
- Usar la app para actividades ilegales.
- Abusar de los servicios opcionales (por ejemplo, spamming desde la
  función de compartir por correo).
...
verdad para tus obligaciones fiscales.

## 5. Modo nube (opcional)

Si activas el modo "En la nube":
...
- Daños indirectos, lucro cesante, o pérdida de datos que tú no hayas
  respaldado.
- Decisiones de negocio que tomes con base en los reportes de la app.

En la máxima medida permitida por la ley aplicable, nuestra
responsabilidad agregada por cualquier reclamo se limita al monto
que hayas pagado por la app en los 12 meses anteriores (cero, si no
has pagado nada).

## 7. Cambios

Si modificamos estos términos, te avisaremos dentro de la app.
Continuar usando la app después del aviso implica aceptación.
