...
export const auditoriasInventario = pgTable(
  ...
  (t) => [index('auditorias_inventario_business_idx').on(t.businessId)],
);

export const conversionRecetas = pgTable(
  'conversion_recetas',
  {
    id: text('id').primaryKey(),
  ...
  (t) => [index('conversion_recetas_business_idx').on(t.businessId)],
);
...
export const conversions = pgTable(
  ...
  (t) => [index('conversions_business_idx').on(t.businessId)],
);
...
export const products = pgTable(
  ...
  (t) => [index('products_business_idx').on(t.businessId, t.nombre)],
);
