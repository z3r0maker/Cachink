/**
 * Migration 0007 — Add `created_by_user_id` to all synced tables.
 *
 * Phase 2 of the Feature Flags plan: audit trail.
 * All columns are nullable — old records have null.
 */

export const migration0007Sql = `ALTER TABLE sales ADD COLUMN created_by_user_id TEXT;
