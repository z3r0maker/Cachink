...
export { VentaCard, type VentaCardProps } from './venta-card';
export { ComprobantePreview, type ComprobantePreviewProps } from './comprobante-preview';
export { VentaDetailPopover, type VentaDetailPopoverProps } from './venta-detail-popover';
export { EditarVentaModal, type EditarVentaModalProps } from './editar-venta-modal';
export { FrecuentesGrid, type FrecuentesGridProps } from './frecuentes-grid';
...
export { TotalCard, SalesContent, VentaRowSlot } from './ventas-sales-pane';
