...
export interface BusinessTypeChoice {
  ...
  /** Initial feature flags seeded from business type selection. */
  readonly initialFeatureFlags?: Partial<FeatureFlags>;
}
...
const CARDS: readonly CardDef[] = [
  {
    ...
    choice: {
      ...
      initialFeatureFlags: { stock: true },
    },
  },
  {
    ...
    choice: {
      ...
      categoriaVentaPredeterminada: 'Producto',
      atributosProducto: [],
      initialFeatureFlags: { stock: false },
    },
  },
  {
    key: 'servicio',
