...
import { computeHealthTones, SaludSection, ThresholdDisclosure } from './indicadores-sections';
import { RentabilidadSection } from './indicadores-rentabilidad';
...
function rotacionSuffix(
  mode: 'mensual' | 'anual' | 'rango' | undefined,
