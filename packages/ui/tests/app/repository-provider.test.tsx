...
describe('useRepositories', () => {
  ...
  it('exposes all 21 repositories (20 entity + referenceData) through the context record', () => {
    renderWithProviders(
...
describe('buildDrizzleRepositories', () => {
  it('returns 21 non-null repository instances wired onto one db + deviceId', () => {
