...
describe('MargenGananciaRow', () => {
  it('renders "$50.00 (50%)" for costo="50" / precio="100"', () => {
    renderWithProviders(
      <TestRow costoPesos="50" precioVentaPesos="100" />,
    );
  ...
  it('renders "—" when costo is empty', () => {
    renderWithProviders(
      <TestRow costoPesos="" precioVentaPesos="100" />,
    );
    const value = screen.getByTestId('margen-ganancia-value');
  ...
  it('renders "—" when precio is empty', () => {
    renderWithProviders(
      <TestRow costoPesos="50" precioVentaPesos="" />,
    );
    const value = screen.getByTestId('margen-ganancia-value');
    expect(value.textContent).toBe('—');
  });
  ...
  it('renders "—" for non-numeric input "abc"', () => {
    renderWithProviders(
      <TestRow costoPesos="abc" precioVentaPesos="100" />,
    );
    const value = screen.getByTestId('margen-ganancia-value');
    expect(value.textContent).toBe('—');
  });
  ...
  it('renders "—" for too many decimal places "1.234"', () => {
    renderWithProviders(
      <TestRow costoPesos="1.234" precioVentaPesos="100" />,
    );
    const value = screen.getByTestId('margen-ganancia-value');
    expect(value.textContent).toBe('—');
  });
  ...
  it('renders "—" when precio is "0"', () => {
    renderWithProviders(
      <TestRow costoPesos="50" precioVentaPesos="0" />,
    );
    const value = screen.getByTestId('margen-ganancia-value');
    expect(value.textContent).toBe('—');
  });
  ...
  it('renders red text when costo > precio (negative margin)', () => {
    renderWithProviders(
      <TestRow costoPesos="150" precioVentaPesos="100" />,
    );
    const value = screen.getByTestId('margen-ganancia-value');
