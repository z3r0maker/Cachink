...
describe('ColorSwatchPicker', () => {
  it('renders the label text', () => {
    renderWithProviders(
      <ColorSwatchPicker label="Color de fondo" value="white" onChange={() => {}} />,
    );
    expect(screen.getByText('Color de fondo')).toBeDefined();
  });

  it('renders swatch elements', () => {
    renderWithProviders(<ColorSwatchPicker label="Color" value="white" onChange={() => {}} />);
  ...
  it('calls onChange when a swatch is pressed', () => {
    ...
    renderWithProviders(<ColorSwatchPicker label="Color" value="white" onChange={onChange} />);
