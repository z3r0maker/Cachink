...
describe('isAuditDue', () => {
  ...
  it('quincenal: due after 14 days', () => {
    expect(
      isAuditDue(
        { tipo: 'quincenal', diaSemana: 1 },
        '2026-04-25' as IsoDate,
        '2026-05-09' as IsoDate,
      ),
    ).toBe(true);
  });
  ...
  it('mensual: due after 28 days', () => {
    expect(
      isAuditDue({ tipo: 'mensual', dia: 1 }, '2026-04-01' as IsoDate, '2026-05-09' as IsoDate),
    ).toBe(true);
  });
  ...
  it('personalizado: due after cadaDias', () => {
    expect(
      isAuditDue(
        { tipo: 'personalizado', cadaDias: 10 },
        '2026-04-28' as IsoDate,
        '2026-05-09' as IsoDate,
      ),
    ).toBe(true);
  });
