 ...
 * switch. PIN hashes are bcrypt — never plaintext. There is one role on the
 * device; the Director lives in the portal (A-05 removed `role`,
 * `mustChangePin`, `recoveryPasswordHash` and `email`).
 */
