/**
 * FAQ_ITEMS — the single source of truth for the home page FAQ and the
 * FAQPage structured data (structured-data.js), so what search engines read
 * is exactly what visitors can open. Keep answers factual and specific: LLMs
 * cite verbatim phrasing.
 */
