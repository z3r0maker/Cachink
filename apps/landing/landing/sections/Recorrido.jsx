...
const rows = [
  {
    ...
    bullets: [
      'Ventas del día en grande',
      'Movimientos con método de pago',
      'Corte de día de un toque',
    ],
    bg: 'var(--offwhite)',
    rotate: -2,
  },
  {
    ...
    bullets: [
      'Monto en MXN, sin calcular IVA a mano',
      'Métodos en botones grandes',
      'Guarda offline; sincroniza después',
    ],
    bg: 'var(--white)',
    rotate: 3,
  },
  {
    ...
    bullets: [
      'KPIs financieros al vuelo',
      'CxC con días de vencimiento',
      'Estados financieros exportables',
    ],
    bg: 'var(--offwhite)',
    rotate: -3,
  },
    ...
    <section id="recorrido" style={{ borderBottom: '2.5px solid var(--black)' }}>
      <div
        style={{
          ...
          padding: `clamp(44px, 8vw, 72px) clamp(20px, 5vw, 28px)`,
        }}
      >
        <div style={{ maxWidth: 1280, margin: '0 auto' }}>
          ...
          <h2
            style={{
              margin: '10px 0 0',
              fontSize: isMobile ? 'clamp(26px, 8vw, 40px)' : 56,
              fontWeight: 900,
      ...
      {rows.map((r, i) => (
        <div
          ...
          style={{
            background: r.bg,
            borderBottom: '2.5px solid var(--black)',
            padding: `clamp(44px, 8vw, 80px) clamp(20px, 5vw, 28px)`,
          }}
        >
          <div
            style={{
          ...
          >
            <div style={{ order: isMobile ? 1 : i % 2 === 0 ? 1 : 2 }}>
              <Reveal from={i % 2 === 0 ? 'right' : 'left'} distance={32}>
                ...
                <h3
                  style={{
                    margin: '10px 0 14px',
                    fontSize: isMobile ? 'clamp(22px, 7vw, 34px)' : 44,
                    fontWeight: 900,
            ...
            {!isMobile && (
              <div
                style={{ order: i % 2 === 0 ? 2 : 1, display: 'flex', justifyContent: 'center' }}
              >
