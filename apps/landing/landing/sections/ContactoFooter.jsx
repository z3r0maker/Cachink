...
function FAQAccordion() {
  ...
  return (
    <section
      id="faq"
      style={{ background: 'var(--white)', borderBottom: '2.5px solid var(--black)' }}
    >
      <div
        style={{
          maxWidth: 1280,
      ...
      >
        <div style={{ maxWidth: 800, margin: '0 auto' }}>
          ...
          <h2
            style={{
              margin: '10px 0 40px',
              fontSize: isMobile ? 'clamp(26px, 7vw, 36px)' : 48,
              fontWeight: 900,
                ...
                >
                  <button
                    ...
                    style={{
                      width: '100%',
                      textAlign: 'left',
                      background: isOpen ? 'var(--yellow)' : 'var(--white)',
                      border: 'none',
                      padding: '18px 20px',
                      cursor: 'pointer',
                      display: 'flex',
        ...
        >
          <div>
            ...
            <h2
              style={{
                margin: '10px 0 20px',
                fontSize: isMobile ? 'clamp(28px, 8vw, 44px)' : 56,
                fontWeight: 900,
  ...
  return (
    <a
      ...
      style={{
        ...
        transition:
          'transform 140ms cubic-bezier(0.2, 0.8, 0.2, 1), box-shadow 140ms, background 140ms',
        color: 'var(--black)',
        display: 'inline-flex',
        alignItems: 'center',
        justifyContent: 'center',
    ...
    >
      <div
        style={{
          maxWidth: 1280,
          margin: '0 auto',
          padding: `clamp(36px, 6vw, 48px) clamp(20px, 5vw, 28px) clamp(24px, 4vw, 36px)`,
        }}
      >
        <div
          style={{
        ...
        >
          <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
            ...
            >
              ...
              <br />
              <span style={{ color: 'var(--gray-600)', fontWeight: 700 }}>
                Hecho en México, con cariño.
              </span>
            </div>
          </div>
          <div
