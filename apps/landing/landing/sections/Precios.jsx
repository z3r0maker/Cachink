    ...
    >
      ...
      >
        <div style={{ textAlign: 'center', marginBottom: 8 }}>
          ...
          >
            Tu negocio sigue aunque se vaya el internet. Prueba 14 días cualquier plan de pago,
            sin tarjeta.
          </p>
        ...
        >
          {PLANES.map((t, i) => {
            ...
            const cad = precio === 0 ? '/ para siempre' : interval === 'mensual' ? '/ mes MXN' : '/ año MXN';
            return (
              <Reveal key={t.id} delay={i * 120} from="up">
                <TiltCard max={5} lift={t.featured ? 12 : 6}>
                  ...
                  >
                    ...
                    <div style={{ fontSize: 13, fontWeight: 600, color: 'var(--gray-600)', marginTop: 2 }}>
                      {t.tagline}
                    </div>
                    <div style={{ display: 'flex', alignItems: 'baseline', gap: 6, marginTop: 6, flexWrap: 'wrap' }}>
                      ...
                      <div style={{ fontSize: 14, fontWeight: 700, color: 'var(--gray-600)' }}>{cad}</div>
                      {precio > 0 && (
                        <div
        ...
        >
          ...
          {mxn2(totalConIva('xangarrote', 'anual'))} al año. Paga con tarjeta de crédito o
          débito, o por transferencia SPEI en plan anual. La exportación de tus datos está
