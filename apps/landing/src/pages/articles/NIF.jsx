  ...
  return (
    ...
    >
      ...
      >
        ...
        aprendieron a leer un estado de resultados. Esta guía explica qué son las NIF, qué dice cada
        uno de los tres estados, cómo se conectan entre sí y cómo generarlos desde tu caja sin saber
        contabilidad.
      </p>
      ...
      <P>
        ...
        <A href="https://www.sat.gob.mx/">SAT</A>. Cuando alguien te pide estados "en formato NIF",
        te pide que la información esté organizada de cierta manera, con ciertos nombres, en cierto
        orden. Ni más ni menos.
      </P>
      <P>
        Las normas se agrupan en series. La serie A es el marco conceptual; la B, las normas de los
        estados financieros en su conjunto; la C, los conceptos específicos (efectivo, inventarios,
        cuentas por cobrar); la D, los problemas de determinación de resultados; la E, las
        industrias especializadas. Para un negocio pequeño importan la A y la B: qué estados existen
        y qué va en cada uno.
      </P>

      <H2>¿Quién las emite y desde cuándo?</H2>
      <P>
        Las emite el <A href="https://www.cinif.org.mx/">CINIF</A>, el Consejo Mexicano de Normas de
        Información Financiera, un organismo independiente creado en 2002 que tomó el relevo del
        Instituto Mexicano de Contadores Públicos, que hasta entonces publicaba los Principios de
        Contabilidad Generalmente Aceptados. Las NIF están en vigor desde el 1 de enero de 2006 y el
        CINIF las actualiza cada año. Todos los contadores mexicanos las conocen; ninguno te va a
        pedir otra cosa.
      </P>
      ...
      <P>
        Los tres cuentan la misma historia desde tres ángulos. Abajo va un mes completo de una fonda
        imaginaria, con los mismos números en los tres estados, para que veas cómo se conectan.
      </P>

      <H2>Cómo leer un estado de resultados en 3 minutos</H2>
      <P>
        Empieza con lo que vendiste y va restando hasta llegar a lo que ganaste. Cada línea amarilla
        es una utilidad distinta: la bruta dice si tu producto deja margen; la de operación, si el
        negocio se sostiene con sus gastos; la neta, lo que queda después de impuestos.
      </P>
      <Tabla caption="Estado de resultados · un mes" rows={RESULTADOS} />
      <P>
        Si la utilidad bruta es buena y la neta es mala, el problema son los gastos, no el producto.
        Si la bruta ya es mala, el problema es el precio o el costo de los insumos.
      </P>
      ...
      <P>
        ...
        salió, que nunca es lo mismo: vendiste $85,400 pero cobraste $80,900, porque $4,500 quedaron
        fiados; pagaste $36,400 a proveedores porque liquidaste $4,400 del mes anterior; y compraste
        una báscula. Por eso el efectivo subió $8,500 y no $21,400.
      </P>
      ...
      <P>
        ...
        flujo. Cuando un número no cuadra entre los tres, algo no se registró: casi siempre un gasto
        en efectivo, un retiro del dueño o una venta fiada. La guía de{' '}
      ...
      <P>
        ...
        desde una libreta. <strong>El banco</strong>, cuando pides un crédito: normalmente balance y
        resultados de los últimos meses, para ver si el negocio paga. <strong>El SAT</strong>, para
        quienes están obligados a llevar contabilidad electrónica; si tributas en RESICO tus
        obligaciones son más simples, pero el estado de resultados sigue siendo la forma más rápida
        de saber si ganas. Y <strong>tú</strong>, cada mes, para decidir precios, compras y sueldos
        con números y no con la sensación de la caja.
      </P>
