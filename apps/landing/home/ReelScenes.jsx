    ...
    <div className="sc sc1 rs-libreta">
      ...
      <div className="pop rs-note">
        <svg viewBox="0 0 340 400" preserveAspectRatio="none" aria-hidden="true">
          <path d="M0 70H340M0 120H340M0 170H340M0 220H340M0 270H340M0 320H340" stroke="var(--blue-soft)" strokeWidth="2" />
...
export function SceneVenta() {
  return (
    <div className="sc sc2 rs-venta">
      <span className="pop rs-coin"><Coin size={190} /></span>
      <span className="up wm rs-wm">¡Xangarro!</span>
      <span className="up d1 xtag rs-sale">Sonó otra venta · <span className="num">+$85.00</span></span>
    </div>
  );
}
...
export function SceneDonCuentas() {
  return (
    <div className="sc sc3 rs-dc">
      <span className="pop rs-avatar"><DonCuentas size={200} /></span>
      <div className="rs-dc-col">
        <span className="up xeyebrow">Don Cuentas · tu asesor con IA</span>
        <div className="up d1 rs-bubble">
          Cierre de agosto: la tortilla te subió 12%. Sube la orden de 5 tacos a $105 y recuperas tu margen.
        </div>
        <div className="up d2 rs-actions">
          <span className="xtag" style={{ background: 'var(--yellow)' }}>Ver revisión</span>
    ...
    <div className="sc sc4 rs-meta">
      <div className="pop rs-seal">
        <svg viewBox="0 0 300 300" aria-hidden="true">
          ...
          <path d={SEAL} fill="var(--yellow)" stroke="var(--black)" strokeWidth="3" transform="translate(6 6)" />
        </svg>
