      ...
      <div className="xh-wrap hero-grid">
        <div className="hero-copy">
          ...
          <p className="xlead hero-sub">
            Control de caja, punto de venta y estados financieros NIF para tu negocio, desde el
            navegador. La caja y el teléfono son las herramientas de tu equipo: ellos cobran y tú
            ves todo aquí, al momento.
          </p>
