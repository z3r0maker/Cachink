...
const TIPS = [
  <>Pedro, la tortilla te subió <strong>12%</strong> este mes. La orden de 5 tacos ya te deja menos margen.</>,
...
function Tip({ n, children }) {
  return (
    <div className="dc-row">
      <span className={`c-av${n}`}><DonCuentas size={38} /></span>
    ...
    <div className="dc-cierre c-ms4">
      <div className="dc-cierre-top">
        ...
        <span className="xtag dc-chip">
          <span className="dc-avatar" style={{ width: 22, height: 22, boxShadow: 'none' }} aria-hidden="true">
      ...
      <p>
        Vendiste 18% más que en julio, pero la tortilla y el gas se comieron 3 puntos de margen. Sube
        la orden de 5 tacos a <strong className="num">$105.00</strong> y la gringa a{' '}
